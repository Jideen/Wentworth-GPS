...
public class Main2Activity extends AppCompatActivity {
    ...
    int bldgGlobal;
    String[] buildingArray, floorArray, roomsArray, floor2Array;
    Context c;
    ...
    public void buttonCode(View v) {
        ...
        toFin.putExtra("Source",selBuilding);
        toFin.putExtra("Dest",selBuilding2);
        startActivity(toFin);
    }
    @Override
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (buildingArray[bldgGlobal]) {
                    case "evw":
                        rooms = new ArrayList<>();
                        floorArray = getResources().getStringArray(R.array.evw_Floors);
                        Log.i("Room Array 1:",floorArray[i]);
                        switch (floorArray[i]) {
                            case "0":
